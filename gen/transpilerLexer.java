...
public class transpilerLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"IDENTIFIER_START", "IDENTIFIER_PART", "FUNCTION", "BEGIN", "END", "PROCEDURE", 
			"INT", "FLOAT", "CONSTINT", "CONSTFLOAT", "OPEN_PAREN", "CLOSE_PAREN", 
			"OPEN_BRACKET", "CLOSE_BRACKET", "SEMICOLON", "COLON", "COMMA", "WALRUS", 
			"PLUS", "MINUS", "TIMES", "SLASH", "AT", "HASH", "CARET", "MOD", "DIV", 
			"EQUAL", "NOT_EQUAL", "LESS_THAN", "GREATER_THAN", "LESS_OR_EQUAL", "GREATER_OR_EQUAL", 
			"AND", "OR", "NOT", "IN", "WHITE_SPACE", "ID", "NUM", "INT_NUM", "FLOAT_NUM", 
			"WORD", "CONSLIT", "ONE_LINE_COMMENT", "MULTILINE_COMMENT"
		};
	}
