...
public class transpilerParser extends Parser {
	...
	public static final int
		...
		OPLOG=32, OPCOMP=33, INC=34, UNIT=35, WHITE_SPACE=36, ID=37, CONSTINT=38, 
		CONSTREAL=39, CONSTLIT=40, ONE_LINE_COMMENT=41, MULTILINE_COMMENT=42;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"OPLOG", "OPCOMP", "INC", "UNIT", "WHITE_SPACE", "ID", "CONSTINT", "CONSTREAL", 
